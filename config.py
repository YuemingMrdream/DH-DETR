...
class Config:
    ...
    # imgDir = '/root/autodl-tmp/Citypersons/Train'
    imgDir2 = '/root/autodl-tmp/Crowdhuman/val'
    # imgDir2 = '/root/autodl-tmp/Citypersons/Val'
    # output_dir = 'AMself_output'
    output_dir = 'DH_head'
    ...
    # train_json = r'/root/autodl-tmp/Citypersons/annotations/train.json'
    # eval_json =  r'/root/autodl-tmp/Citypersons/annotations/val.json'
    anno_file = osp.join(imgDir, '..', 'odformat', 'crowdhuman_val.odgt')
    # anno_file = r'CitypersonVal.odgt'
    train_file = osp.join(imgDir, '..', 'odformat', 'crowdhuman_train.odgt')
    # train_file = r'CHtrain.odgt'
