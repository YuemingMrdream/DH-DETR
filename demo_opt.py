...
if __name__ == "__main__":
    ...
    # gt_path = 'CitypersonVal.odgt'
    gt_path = 'CHval.odgt'
    # gt_path = r'/root/autodl-tmp/Citypersons/annotations/ValCityperson.json'
    ...
    for i in range(int(sys.argv[2]), 155):
        # fpath = os.path.join(r'DH_head/eval_dump/DETR_Baseline', 'epoch-{}.human'.format(i))
        # fpath = os.path.join(r'CITY_output/eval_dump/CITYPERSON_1_0', 'epoch-{}.human'.format(i))
        fpath = os.path.join(r'DH_head/eval_dump/two-stage-deformable-ADis-real-3-2-ONLY-ID_token-subtract-norm-addq-Giou500', 'epoch-{}.human'.format(i))
